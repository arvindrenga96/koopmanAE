...
daeSubfolder="${jobDirectory}/results_det_pendulum_6_noise_08_DAE"
koopmanAeSubfolder="${jobDirectory}/results_det_pendulum_6_noise_08_Koopman_AE"
koopmanInnSubfolder="${jobDirectory}/results_det_pendulum_6_noise_08_KOOPMAN_AE_INN"
rnnSubfolder="${jobDirectory}/results_det_pendulum_6_noise_08_RNN_NEW"
...
#DAE
command_1="python driver.py --alpha 1 --dataset pendulum --noise $noise --lr 1e-2 --epochs $epochs --batch 64 --folder $daeSubfolder --lamb 1 --steps 8 --bottleneck 6  --lr_update  30 200 400 500 --lr_decay 0.2 --pred_steps 1000 --backward 0 --seed $seed"
...
command_2="python driver.py --alpha 1 --dataset pendulum --noise $noise --lr 1e-2 --epochs $epochs --batch 64 --folder $koopmanAeSubfolder --lamb 1 --steps 8 --bottleneck 6  --lr_update  30 200 400 500 --lr_decay 0.2 --pred_steps 1000 --backward 1 --steps_back 8 --nu 1e-1 --eta 1e-2 --seed $seed"

python generate_script.py "$koopmanAeSubfolder" "$command_2" "${jobDirectory}/koopman_script"
sbatch "${jobDirectory}/koopman_script.sh"

#KOOPMAN_AE_INN
command_3="python driver.py --alpha 1 --dataset pendulum --noise $noise --lr 1e-2 --epochs $epochs --batch 64 --folder $koopmanInnSubfolder --lamb 1 --steps 8 --bottleneck 6  --lr_update  30 200 400 500 --lr_decay 0.2 --pred_steps 1000 --backward 1 --steps_back 8 --nu 1 --eta 0 --seed $seed --model koopmanAE_INN"
...
command_4="python driver.py --alpha 1 --dataset pendulum --noise $noise --lr 1e-2 --epochs $epochs --batch 64 --folder $rnnSubfolder --lamb 1 --steps 8 --bottleneck 6  --lr_update  30 200 400 500 --lr_decay 0.2 --pred_steps 1000 --backward 0 --seed $seed --model LSTM"
